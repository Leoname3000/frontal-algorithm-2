...
public class TrueCombinedComparator implements Comparator<Operation> {
    @Override
    public int compare(Operation o1, Operation o2) {
        ...
        if (lsc.compare(o1, o2) < -1 || lsc.compare(o1, o2) > 1) return lsc.compare(o1, o2);

        var dc1 = new DeadlineComparator();
        if (dc1.compare(o1, o2) < -1 || dc1.compare(o1, o2) > 1) return dc1.compare(o1, o2);

        var dc2 = new DurationComparator();
        if (dc2.compare(o1, o2) < -1 || dc2.compare(o1, o2) > 1) return dc2.compare(o1, o2);

        var fdc = new FollowingDurationsComparator();
        if (fdc.compare(o1, o2) < -1 || fdc.compare(o1, o2) > 1) return fdc.compare(o1, o2);

        var fc = new FollowersComparator();
        if (fc.compare(o1, o2) < -1 || fc.compare(o1, o2) > 1) return fc.compare(o1, o2);
