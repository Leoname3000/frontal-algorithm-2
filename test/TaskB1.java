...
//    Operation d1, d2, d3;
    ...
    public TaskB1() {
        ...
        Schedule schedule2 = new Schedule.ScheduleBuilder()
                .addWeek(startingDate, LocalTime.of(11, 0), LocalTime.of(14, 0))
                .addWeek(startingDate, LocalTime.of(15, 0), LocalTime.of(18, 0))
...
//                .addWeek(startingDate.plusDays(7), LocalTime.of(15, 0), LocalTime.of(19, 0))
        ...
        LocalDateTime deadline1 = startingDate.plusDays(2).atTime(14, 0);
        Lot lot_a = new Lot("lot_a", arrival1, deadline1, 0);
        a1 = new Operation("a1", group, lot_a, duration.plusHours(3), false);
        a2 = new Operation("a2", group, lot_a, duration.plusHours(3), false);
        a3 = new Operation("a3", group, lot_a, duration.plusHours(3), false);
//        a4 = new Operation("a4", group, lot_a, duration.plusHours(1), false);
//        a5 = new Operation("a5", group, lot_a, duration.plusHours(1), false);
//        a6 = new Operation("a6", group, lot_a, duration.plusHours(1), false);
//        a7 = new Operation("a7", group, lot_a, duration.plusHours(1), false);
...
//        Lot.addRelation(a1, a4);
//        Lot.addRelation(a4, a5);
...
//        allLots.add(lot_d);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Solution solution = task.frontalAlgorithm.iterRun(new TimeCapacityStrategy(new TrueCombinedComparator(), Duration.ofMinutes(61), 100));
