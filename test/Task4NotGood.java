...
//                .build();
        ...
        LocalDateTime deadline1 = startingDate.plusDays(3).atTime(19, 0);
...
//        Lot.addRelation(a3, a7);
        ...
        LocalDateTime deadline2 = startingDate.plusDays(3).atTime(19, 0);
