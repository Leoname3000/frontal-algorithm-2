...
public class TaskB4 {
    ...
    Resource res1, res2;
    Operation a1, a2, a3, a4, a5, a6, a7, a8, a9;
...
//    Operation d1, d2, d3;
    ...
    public TaskB4() {
        ...
        Schedule schedule1 = new Schedule.ScheduleBuilder()
                .addWeek(startingDate.plusDays(0), LocalTime.of(10, 0), LocalTime.of(15, 0))
                .addWeek(startingDate.plusDays(7), LocalTime.of(10, 0), LocalTime.of(15, 0))
                .build();

        Schedule schedule2 = new Schedule.ScheduleBuilder()
                .addWeek(startingDate.plusDays(0), LocalTime.of(11, 0), LocalTime.of(14, 0))
                .addWeek(startingDate.plusDays(7), LocalTime.of(11, 0), LocalTime.of(14, 0))
...
//                .addWeek(startingDate.plusDays(7), LocalTime.of(15, 0), LocalTime.of(19, 0))
        ...
        LocalDateTime deadline1 = startingDate.plusDays(3).atTime(15, 0);
        ...
        a5 = new Operation("a5", group, lot_a, duration.plusHours(3), false);
        a6 = new Operation("a6", group, lot_a, duration.plusHours(3), false);
        a7 = new Operation("a7", group, lot_a, duration.plusHours(3), false);
        a8 = new Operation("a8", group, lot_a, duration.plusHours(3), false);
        a9 = new Operation("a9", group, lot_a, duration.plusHours(1), false);
        ...
        lot_a.add(a8);
        lot_a.add(a9);
        Lot.addRelation(a1, a9);
        Lot.addRelation(a2, a9);
        Lot.addRelation(a3, a9);
        Lot.addRelation(a4, a9);
        Lot.addRelation(a5, a6);
        Lot.addRelation(a6, a7);
        Lot.addRelation(a7, a8);
        Lot.addRelation(a8, a9);


        LocalDateTime arrival2 = startingDate.plusDays(0).atTime(10, 0);
        LocalDateTime deadline2 = startingDate.plusDays(6).atTime(15, 0);
        Lot lot_b = new Lot("lot_b", arrival2, deadline2, 0);
        b1 = new Operation("b1", group, lot_b, duration.plusHours(4), false);
        b2 = new Operation("b2", group, lot_b, duration.plusHours(2), false);
        b3 = new Operation("b3", group, lot_b, duration.plusHours(4), false);
        b4 = new Operation("b4", group, lot_b, duration.plusHours(2), false);
        b5 = new Operation("b5", group, lot_b, duration.plusHours(4), false);
        b6 = new Operation("b6", group, lot_b, duration.plusHours(2), false);
        b7 = new Operation("b7", group, lot_b, duration.plusHours(1), false);
        ...
        Lot.addRelation(b4, b5);
        Lot.addRelation(b5, b6);
...
//        allLots.add(lot_d);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Solution solution = task.frontalAlgorithm.iterRun(new TimeCapacityStrategy(new TrueCombinedComparator(), Duration.ofMinutes(61), 2));
