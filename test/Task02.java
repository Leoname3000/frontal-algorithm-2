...
//                .build();
        ...
        LocalDateTime deadline1 = startingDate.plusDays(0).atTime(16, 0);
        ...
        a3 = new Operation("a3", group, lot_a, duration.plusHours(1), false);
...
//        Lot.addRelation(a3, a7);
        ...
        LocalDateTime deadline2 = startingDate.plusDays(2).atTime(16, 0);
        Lot lot_b = new Lot("lot_b", arrival2, deadline2, 0);
        b1 = new Operation("b1", group, lot_b, duration.plusHours(6), false);
        b2 = new Operation("b2", group, lot_b, duration.plusHours(3), false);
        b3 = new Operation("b3", group, lot_b, duration.plusHours(3), false);
...
//        allLots.add(lot_d);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            var task = new Task02();
            Solution solution = task.frontalAlgorithm.run(new FollowingDurationsComparator());
