...
//                .build();
        ...
        LocalDateTime deadline1 = startingDate.plusDays(0).atTime(14, 0); // TODO: 16 for 22H
...
//        Lot.addRelation(a3, a7);
        ...
        b1 = new Operation("b1", group, lot_b, duration.plusHours(2), false);
        b2 = new Operation("b2", group, lot_b, duration.plusHours(2), false);
        b3 = new Operation("b3", group, lot_b, duration.plusHours(2), false);
