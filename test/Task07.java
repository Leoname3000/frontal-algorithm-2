...
//                .build();
        ...
        LocalDateTime deadline1 = startingDate.plusDays(3).atTime(18, 0);
        ...
        a5 = new Operation("a5", group, lot_a, duration.plusHours(2), false);
        a6 = new Operation("a6", group, lot_a, duration.plusHours(2), false);
        a7 = new Operation("a7", group, lot_a, duration.plusHours(2), false);
        ...
        LocalDateTime deadline2 = startingDate.plusDays(1).atTime(18, 0);
        Lot lot_b = new Lot("lot_b", arrival2, deadline2, 0);
        b1 = new Operation("b1", group, lot_b, duration.plusHours(8), false);
        b2 = new Operation("b2", group, lot_b, duration.plusHours(8), false);
